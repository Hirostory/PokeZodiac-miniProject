...
const allZodiac = {
    capricorn: {
        pokemon: [{pokemo: 3, reason: "<p>Capricorns are known for their grounded and practical nature. Venusaur is a Grass/Poison-type Pokémon, representing the Earth element and a connection to the natural world. Its strong connection to plants and the environment aligns with Capricorn's appreciation for stability and being in touch with the physical world.</p>" + "<p> Both Capricorn and Venusaur can be strong and enduring. Venusaur's sturdy and powerful appearance reflects Capricorn's determination and ability to handle challenges with resilience.</p>" + "<p> Capricorns are often associated with the winter season, and Venusaur's final evolutionary stage can be seen as a symbol of maturity and growth, aligning with the Capricorn's theme of progress and development.</p>" + "<p> Venusaur's ability to use plants and flowers for various attacks represents its nurturing and protective qualities, much like how Capricorns are known for being caring and protective of their loved ones.</p>" + "<p> Capricorns are ruled by Saturn, which is associated with responsibility and hard work. Venusaur's status as a fully evolved Pokémon reflects its growth and evolution, paralleling Capricorn's goal-oriented and ambitious nature.</p>",},{pokemo: 144, reason: "<p>Capricorn is an Earth sign, and Articuno's Ice/Flying typing aligns with the element of Ice, which can be linked to the Earth element due to its solid and cold nature.</P>" + "<p>Both Capricorn and Articuno are known for their strong and resilient nature. Capricorns are often described as disciplined and hardworking, and Articuno's majestic and imposing appearance reflects these qualities.</p>" + "<p>Articuno's moves like Ice Beam and Blizzard demonstrate its icy power and the ability to control its environment, symbolizing Capricorn's determination and ability to handle challenges.</p>" +
        "<p>Articuno's name and design draw inspiration from the mythical Phoenix, which is often associated with the theme of rebirth and transformation, aligning with Capricorn's theme of growth and evolution.</p>" +"<p>Capricorns are known for their ambition and desire for success, and Articuno's status as one of the legendary birds represents its significance and power in the Pokémon world.</p>" + "<p>Articuno's elegant and composed presence resonates with Capricorn's symbol, the Goat, often depicted as a goat with a fish's tail.</p>", }],
        sign: "Capricorn",
    },
    aries: {
...
//still doing trials on getting the right pokemons might do maybe the arrays instead.... we'll see
function pickRandom() {
